...
def check_gradient(f, x, delta=1e-5, tol=0.1):
    """
    ...
    # if x.ndim > 2:
    #   analytic_grad = analytic_grad.reshape(analytic_grad.shape[0] \
    #     *analytic_grad.shape[1]*analytic_grad.shape[2], analytic_grad.shape[-1])
